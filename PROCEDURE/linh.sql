...
BEGIN
	...
	FROM PHIEUDATPHONG PDP JOIN THONGTINDOAN TTD ON PDP.MAKH = TTD.MAKH	JOIN NHANVIEN NV ON NV.MANV = PDP.MANV
	WHERE MAPDK = @MAPDK;

	SELECT CT.MAPHONG, P.LOAIPHONG, CT.NOTE 
	FROM CHITIETDATPHONG CT JOIN PHONG P ON CT.MAPHONG = P.MAPHONG
	WHERE CT.MAPDK = @MAPDK;

END
GO

--exec ChiTietHoaDonPhong 'PDKa5b4753cbfb7';
